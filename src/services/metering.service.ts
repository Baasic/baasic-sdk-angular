...
export class MeteringService {
     ...
     * @example MeteringService.create({   
     ...
     * @example // meteringData is a resource previously fetched using get action. 
                    ...
                    MeteringService.update(meteringData)
                        .then(function (data) {   
                            // perform success action here 
                        },
                         function (response, status, headers, config) {   
     ...
     * @example // meteringData is a resource previously fetched using get action.				 
                        MeteringService.remove(meteringData)
                            .then(function (data) {   
                                // perform success action here 
                            },
                             function (response, status, headers, config) {   
    ...
    get batch(): IMeteringBatchService {
        ...
        return {
             ...
             * @example  MeteringService.batch.create([{     
            ...
            **/
             ...
             * @example   MeteringService.batch.update(companies)
                                .then(function (data) {     
                                    // perform success action here   
                                },
                                function (response, status, headers, config) {     
            ...
            * @returns A promise that is resolved once the remove action has been performed.                    
            * @example MeteringService.batch.remove(companyIds)
                           .then(function (data) {     
                               // perform success action here   
                           },
                           function (response, status, headers, config) {     
    ...
    get statistics(): IMeteringStatisticsService {
        let baasicApp = this.baasicApp;
        return {
            /**                    
             * Returns a promise that is resolved once the find action has been performed. Success response returns a list of metering resources matching the given criteria.                    
             ...
             * @param options Query resource options object. 
             * @returns A promise that is resolved once the find action has been performed.                         
             * @example MeteringService.statistics.find({     
                            pageNumber : 1,     
                            pageSize : 10,     
                            orderBy : '<field>',     
                            orderDirection : '<asc|desc>',     
    ...
    get acl(): IACLService {
        ...
        return {
             ...
             * @param options Query resource options object.
             * @returns A promise that is resolved once the get action has been performed.                            
             * @example MeteringService.acl.get({id: '<id>'})
                         .then(function (data) {   
                             // perform success action here 
                         },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example let options = {id : '<id>'}; 
                        ...
                        MeteringService.acl.update(options)
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example MeteringService.acl.removeByUser('<id>', '<access-action>', '<username>')
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            * @example MeteringService.acl.removeByRole('<id>', '<access-action>', '<role-name>')
                           .then(function (data) {   
                               // perform success action here 
                           },
                           function (response, status, headers, config) {   
    ...
    get settings(): IMeteringSettingsService {
        let baasicApp = this.baasicApp;
        return {
            /**                 
             * Returns a promise that is resolved once the get action has been performed. Success response returns the metering resource.                 
    ...
    get category(): IMeteringCategoryService {
        let baasicApp = this.baasicApp;
        return {
            /**                  
             * Returns a promise that is resolved once the find action has been performed. Success response returns a list of metering resources matching the given criteria.                  
             ...
             * @param options Query resource options object.
             * @returns A promise that is resolved once the find action has been performed.                          
             * @example MeteringService.category.find({   
                            pageNumber : 1,   
                            pageSize : 10,   
                            orderBy : '<field>',   
                            orderDirection : '<asc|desc>',   
            ...
            **/
             ...
             * @param options Query resource options object.
             * @returns A promise that is resolved once the get action has been performed.                        
             * @example MeteringService.category.get(id)
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @returns A promise that is resolved once the create metering action has been performed.                         
             * @example MeteringService.category.create({   
                            category : '<category-name>',   
                            unitName : 'Kb',   
                            unitFactor: 1,   
            ...
            **/
             ...
             * @example // meteringCategory is a resource previously fetched using get action. 
                            ...
                            MeteringService.category.update(meteringCategory)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @returns A promise that is resolved once the remove action has been performed.                        
             * @example // meteringCategory is a resource previously fetched using get action.				 
                            MeteringService.category.remove(meteringCategory)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
            ...
            batch: {
                 ...
                 * @example  MeteringService.category.batch.create([{     
                ...
                **/
                 ...
                 * @example    MeteringService.category.batch.update(companies)
                                .then(function (data) {     
                                    // perform success action here   
                                },
                                function (response, status, headers, config) {     
                ...
                **/
                 ...
                 * @returns A promise that is resolved once the remove action has been performed.                         
                 * @example  MeteringService.category.batch.remove(companyIds)
                                .then(function (data) {     
                                    // perform success action here   
                                },
                                function (response, status, headers, config) {     
