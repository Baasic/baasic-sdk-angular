...
import {
    ...
    IMediaVaultProcessingProviderSettingsService,
    IMediaVaultSettingsService,
    ...
    **/
    ...
    get batch(): IMediaVaultBatchService {
        ...
        return {
             ...
             * @example MediaVaultService.batch.update(files)
                         .then(function (data) {   
                             // perform success action here 
                         },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example // Remove original media vault resources		 
                                MediaVaultService.batch.remove([{ id: '<media-vault-id>' }])
                                    .then(function (data) {   
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {   
                        ...
                        // Remove derived media vault resources		 
                                MediaVaultService.batch.remove([{ id: '<media-vault-id>', fileFormat: { width: <width>, height: <height> } }])
                                    .then(function (data) {   
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {   
    ...
    get streams(): IMediaVaultStreamsService {
        ...
        return {
             ...
             * @example // Request the original media vault stream   
                                MediaVaultService.streams.get('<path>')
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
                        ...
                        // Request derived media vault stream 
                                MediaVaultService.streams.get({id: '<path>', width: <width>, height: <height>})
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
            ...
            **/
             ...
             * @example // Request the original blob   
                                MediaVaultService.streams.getBlob('<path>')
                                    .then(function (data) {   
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
                        ...
                        // Request derived blob   
                                MediaVaultService.streams.getBlob({id: '<path>', width: <width>, height: <height>})
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
            ...
            **/
             ...
             * @method                   
             * @example MediaVaultService.streams.create('<path>', <blob>)
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example // Update existing original media vault stream 
                                MediaVaultService.streams.update('<path>', <media-vault-stream>)
                                    .then(function (data) {   
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {   
                        ...
                        // Update derived media vault stream 
                            MediaVaultService.streams.update({id: '<path>', width: <width>, height: <height>}, <media-vault-stream>)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
    ...
    get settings(): IMediaVaultSettingsService {
        ...
        return {
            ...
            * @method    
            * @returns A promise that is resolved once the get action has been performed.                        
            * @example MediaVaultService.settings.get()
                           .then(function (data) {     
                               // perform success action here 
                           },
                           function (response, status, headers, config) {     
           ...
           **/
             ...
             * @returns A promise that is resolved once the update action has been performed.                    
             * @example MediaVaultService.settings.update(mediaVaultSettings)
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
    ...
    get processingProviderSettings(): IMediaVaultProcessingProviderSettingsService {
        ...
        return {
             ...
             * @param options Query resource options object.
             * @returns A promise that is resolved once the find action has been performed.                          
             * @example MediaVaultService.processingProviderSettings.find({   
                            pageNumber : 1,   
                            pageSize : 10,   
                            orderBy : '<field>',   
                            orderDirection : '<asc|desc>',   
            ...
            **/
             ...
             * @param options Query resource options object.
             * @returns A promise that is resolved once the get action has been performed.                   
             * @example MediaVaultService.processingProviderSettings.get('<id>')
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example // processingProviderSettings is a resource previously fetched using get action. 
                            ...
                            MediaVaultService.processingProviderSettings.update(processingProviderSetting)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
