...
export class DynamicResourceService {
     ...
     * @example DynamicResourceService.find('<schema-name>', {   
                    pageNumber : 1,   
                    pageSize : 10,   
                    orderBy : '<field>',   
     ...
     * @method                         
     * @example DynamicResourceService.get('<schema-name>', '<dynamic-resource-id>')
                    .then(function (data) {   
                        // perform success action here 
                    }, 
                     function (response, status, headers, config) {   
     ...
     * @example DynamicModuleService.create('<schema-name>', {   
                    id : '',   
     ...
     * @example // dynamicResource is a resource previously fetched using get action. 
                    ...
                    DynamicResourceService.patch(dynamicResource, {   
                        query: "where field = 'value' " 
                    })
                    .then(function (data) {   
                        // perform success action here 
     ...
     * @example // dynamicResource is a resource previously fetched using get action.				 
                    DynamicResourceService.remove(dynamicResource, {   
                        query: "where field = 'value' " 
                    })
                    .then(function (data) {   
                        // perform success action here 
    ...
    get schema(): IDynamicResourceSchemaService {
        ...
        return {
             ...
             * @method
             * @param options Options object.                      
             * @example DynamicResourceService.scema.find({ 
                            pageNumber : 1,   
                            pageSize : 10,   
                            orderBy : '<field>',   
                            orderDirection : '<asc|desc>',   
            ...
            **/
             ...
             * @param options Options object.                         
             * @example DynamicResourceService.schema.get('<schema-name>')
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example DynamicResourceService.schema.create({   
                            schema : {  
                                type : 'object',     
                                properties : { 
                                    id : {
            ...
            **/
             ...
             * @example // dynamicResourceSchema is a resource previously fetched using get action. 
                            ...
                            DynamicResourceService.schema.update(dynamicResourceSchema)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example // dynamicResourceSchema is a resource previously fetched using get action.				 
                            DynamicResourceService.schema.remove(dynamicResourceSchema)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example DynamicResourceService.schema.generate({ 
                            id : '<schema-Id>',   
                            description : '<description>' 
                        })
                        .then(function (data) {   
    ...
    get acl(): IDynamicResourceACLService {
        ...
        return {
             ...
             * @method
             * @param options Options object.                           
             * @example DynamicResourceService.acl.get({id: '<dynamic-resource-id>', schemaName: '<schema-name>'})
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @method
             * @param options Options object.                        
             * @example DynamicResourceService.acl.update({id: '<dynamic-resource-id>', schemaName: '<schema-name>'})
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example // dynamicResource is a resource previously fetched using get action.					
                            DynamicResourceService.acl.removeByUser('<access-action>', '<username>', dynamicResource)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @param data ACL Policy whose security privileges need to be retrieved and updated.                     
             * @example // dynamicResource is a resource previously fetched using get action. 
                            DynamicResourceService.acl.removeByRole('<access-action>', '<role-name>', dynamicResource)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
