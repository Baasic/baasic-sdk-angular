...
export class FilesService {
     ...
     * @example FilesService.get('<file-id>')
                    .then(function (data) {   
                        // perform success action here 
                    },
                     function (response, status, headers, config) {   
     ...
     * @example // fileEntry is a file resource previously fetched using get action. The following action will remove the original file resource and all accompanying derived file resources.			 
                ...
                // fileEntry is a file resource previously fetched using get action. The following action will remove derived file resource only.		 
                    FilesService.unlink(fileEntry, {width: <width>, height: <height>})
                        .then(function (data) {   
                            // perform success action here 
                    },
                     function (response, status, headers, config) {   
     ...
     * @example FilesService.link(fileObject)
                   .then(function (data) {   
                       // perform success action here 
                   },
                    function (response, status, headers, config) {   
    ...
    **/
    ...
    get batch(): IFilesBatchService {
        ...
        return {
             ...
             * @example FilesService.batch.update(files)
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @returns A promise that is resolved once the link action has been performed.                       
             * @example FilesService.batch.link(files)
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example // Remove original file resources                
                            FilesService.batch.unlink([{ id: '<file-id>' }])
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {  
                        ...
                        // Remove derived file resources  
                            FilesService.batch.unlink([{ id: '<file-id>', fileFormat: { width: <width>, height: <height> } }])
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
    ...
    get streams(): IFilesStreamsService {
        ...
        return {
             ...
             * @example // Request the original file stream              
                                FilesService.streams.get({id: '<path>'})
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
                        ...
                        // Request derived file stream                
                            FilesService.streams.get({id: '<path>', width: <width>, height: <height>})
                                .then(function (data) {     
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {    
            ...
            **/
             ...
             * @example // Request the original blob                
                            FilesService.streams.getBlob('<path>')
                                .then(function (data) {     
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {    
                        ...
                        // Request derived blob                 
                            FilesService.streams.getBlob({id: '<path>', width: <width>, height: <height>})
                                .then(function (data) {     
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {     
            ...
            **/
             ...
             * @example // Update original file stream 
                            FilesService.streams.update('<path>', <file-stream>)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
                        ...
                        // Update derived file stream 
                            FilesService.streams.update({id: '<path>', width: <width>, height: <height>}, <file-stream>)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @method                    
             * @example FilesService.streams.create('<path>', <blob>)
                         .then(function (data) {   
                             // perform success action here 
                         },
                            function (response, status, headers, config) {   
