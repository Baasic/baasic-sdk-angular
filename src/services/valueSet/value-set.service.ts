...
export class ValueSetService {
     ...
     * @method
     * @example ValueSetService.get('<value-set-name>')
    ...
    **/
     ...
     * @method
     * @example ValueSetService.create({
                    name: '<value-set-name>',
     ...
     * @example // valueSet is a resource previously fetched using get action. 
                        ...
                        ValueSetService.update(valueSet)
                            .then(function (data) {   
                                // perform success action here 
                            },
                             function (response, status, headers, config) {   
     ...
     * @method                         
     * @example // valueSet is a resource previously fetched using get action.				 
                    valueSetService.remove(valueSet)
                        .then(function (data) {   
                            // perform success action here 
                        },
                         function (response, status, headers, config) {   
    ...
    get items(): IValueSetItemService {
        ...
        return {
            ...
            * @method items.find
            * @example ValueSetService.items.find({
            ...
            * @returns A promise that is resolved once the get action has been performed.
            * @method items.get
            * @example ValueSetService.items.get('<value-set-name>', '<set-item-id>')
                        .then(function (data) {   
                               // perform success action here 
                       },
                       function (response, status, headers, config) {   
           ...
           **/
             ...
             * @example ValueSetService.items.create({
                            setId: '<value-set-id>', 
                            value: '<value>'
                        })
                        .then(function (data) {   
            ...
            **/
             ...
             * @example // valueSetItem is a resource previously fetched using get action. 
                        ...
                        ValueSetItemService.items.update(valueSetItem)
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {  
            ...
            **/
             ...
             * @method 
             * @example // valueSetItem is a resource previously fetched using get action.
                        ValueSetItemService.items.remove(valueSetItem)
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
