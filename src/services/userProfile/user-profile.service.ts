...
export class UserProfileService {
    ...
    get profile(): IUserProfileService {
    ...
    get company(): ICompanyService {
        ...
        return {
            ...
            **/
             ...
             * @example UserProfileService.company.create({   
            ...
            **/
             ...
             * @example // company is a resource previously fetched using get action. 
                            ...
                            UserProfileService.company.update(company)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @returns A promise that is resolved once the remove action has been performed.                          
             * @example // company is a resource previously fetched using get action.				 
                            UserProfileService.company.remove(company)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
            ...
            batch: {
                 ...
                 * @returns A promise that is resolved once the create company action has been performed.                          
                 * @example  UserProfileService.company.batch.create([{     
                                description : '<description>',     
                                name : '<name>',     
                                slug: '<slug>'   
                            }])
                ...
                **/
                 ...
                 * @returns A promise that is resolved once the update company action has been performed.                         
                 * @example   UserProfileService.company.batch.update(companies)
                                .then(function (data) {     
                                    // perform success action here   
                                },
                                function (response, status, headers, config) {     
                ...
                **/
                 ...
                 * @returns A promise that is resolved once the remove action has been performed.                          
                 * @example UserProfileService.company.batch.remove(companyIds)
                             .then(function (data) {     
                                 // perform success action here   
                             }, 
                                function (response, status, headers, config) {     
    ...
    get organization(): IOrganizationService {
        let baasicApp = this.baasicApp;
        return {
            /**                  
             ...
             * @param options Query resource options object. 
             * @returns A promise that is resolved once the find action has been performed.                      
             * @example UserProfileService.organization.find({   
                            pageNumber : 1,   
                            pageSize : 10,   
                            orderBy : '<field>',   
                            orderDirection : '<asc|desc>',   
            ...
            **/
             ...
             * @param options Query resource options object.
             * @returns A promise that is resolved once the get action has been performed.                       
             * @example UserProfileService.organization.get(id, options)
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example UserProfileService.organization.create({   
                            description : '<description>',   
                            name : '<name>',   
                            slug: '<slug>' 
                        })
            ...
            **/
             ...
             * @example // organization is a resource previously fetched using get action. 
                            ...
                            UserProfileService.organization.update(organization)
                                .then(function (data) {   
                                    // perform success action here 
                                }, 
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @returns A promise that is resolved once the remove action has been performed.                         
             * @example // organization is a resource previously fetched using get action.				 
                             UserProfileService.organization.remove(organization)
                                 .then(function (data) {   
                                     // perform success action here 
                                 },
                                    function (response, status, headers, config) {   
            ...
            **/
            ...
            batch: {
                 ...
                 * @returns A promise that is resolved once the create organization action has been performed.                          
                 * @example   UserProfileService.organization.batch.create([{     
                                description : '<description>',     
                                name : '<name>',     
                                slug: '<slug>'   
                            }])
                ...
                **/
                 ...
                 * @returns A promise that is resolved once the update organization action has been performed.                         
                 * @example   UserProfileService.organization.batch.update(organizations)
                                .then(function (data) {     
                                    // perform success action here   
                                }, 
                                function (response, status, headers, config) {     
                ...
                **/
                 ...
                 * @method                         
                 * @example UserProfileService.organization.batch.remove(organizationIds)
                                .then(function (data) {     
                                    // perform success action here   
                                },
                                function (response, status, headers, config) {     
    ...
    get skill(): ISkillService {
        ...
        return {
             ...
             * @param options Query resource options object.
             * @returns A promise that is resolved once the find action has been performed.                         
             * @example UserProfileService.skill.find({   
                            pageNumber : 1,   
                            pageSize : 10,   
                            orderBy : '<field>',   
                            orderDirection : '<asc|desc>',   
            ...
            **/
             ...
             * @param options Query resource options object.                        
             * @example UserProfileService.skill.get(id, options)
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example UserProfileService.skill.create({   
                            description : '<description>',   
                            name : '<name>',   
                            slug: '<slug>' 
                        })
            ...
            **/
             ...
             * @example // skill is a resource previously fetched using get action. 
                            skill.description = '<description>'; 
                            UserProfileService.skill.update(skill)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @returns A promise that is resolved once the remove action has been performed.                          
             * @example // skill is a resource previously fetched using get action.				 
                             UserProfileService.skill.remove(skill)
                                 .then(function (data) {   
                                     // perform success action here 
                                 }, 
                                    function (response, status, headers, config) {   
            ...
            **/
            ...
            batch: {
                 ...
                 * @returns A promise that is resolved once the create skill action has been performed.                         
                 * @example   UserProfileService.skill.batch.create([{     
                                description : '<description>',     
                                name : '<name>',     
                                slug: '<slug>'   
                            }])
                ...
                **/
                 ...
                 * @returns A promise that is resolved once the update skill action has been performed.                         
                 * @example   UserProfileService.skill.batch.update(companies)
                                .then(function (data) {     
                                    // perform success action here   
                                }, 
                                function (response, status, headers, config) {     
                ...
                **/
                 ...
                 * @returns A promise that is resolved once the remove action has been performed.                        
                 * @example UserProfileService.skill.batch.remove(skillIds)
                                .then(function (data) {     
                                    // perform success action here   
                                }, 
                                function (response, status, headers, config) {     
