...
import {
    ...
    INotification,
    INotificationsPublishService,
    INotificationsRegistrationsService,
...
export class NotificationsService {
    ...
    get publish(): INotificationsPublishService {
        ...
        return {
             ...
             * @example NotificationsService.create({     
            ...
            */
            ...
            batch: {
                 ...
                 * @returns A promise that is resolved once the create notification action has been performed.                              
                 * @example NotificationsService.batch.create([{        
                                channels: ['<channel-name', '<channel-name>'],     
                                moduleName: '<module-name>',     
                                templateName: '<template-name>',     
                                templateContext: {         
    ...
    get subscriptions(): INotificationsSubscriptionsService {
        let baasicApp = this.baasicApp;
        return {
            anonymous: {
                /**                          
                 ...
                 * @example NotificationsService.subscriptions.anonymous.create({     
                ...
                */
                 ...
                 * @example NotificationsService.subscriptions.anonymous.find({     
                                pageNumber : 1,     
                                pageSize : 10,     
                                orderBy : '<field>',     
                ...
                */
                 ...
                 * @example NotificationsService.subscriptions.anonymous.get('<subscription-id>')
                                .then(function (data) {     
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {     
                ...
                */
                 ...
                 * @example // subscription is a resource previously fetched using get action.				 
                                    NotificationsService.subscriptions.anonymous.remove(subscription)
                                        .then(function (data) {     
                                            // perform success action here 
                                        },
                                        function (response, status, headers, config) {     
                ...
                */
                 ...
                 * @example // subscription is a resource previously fetched using get action. 
                                ...
                                NotificationsService.subscriptions.anonymous.update(subscription) 
                                    .then(function (data) {         
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {         
                ...
                */
                ...
                batch: {
                     ...
                     * @returns A promise that is resolved once the create anonymous subscription action has been performed.
                     * @example NotificationsService.subscriptions.anonymous.batch.create([{     
                                    channel: '<channel-name>',     
                    ...
                    */
                     ...
                     * @example NotificationsService.subscriptions.anonymous.batch.remove(subscriptionIds)
                                 .then(function (data) {     
                                     // perform success action here 
                                 },
                                    function (response, status, headers, config) {     
                    ...
                    */
                     ...
                     * @example NotificationsService.subscriptions.anonymous.batch.update(subscriptions)
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
            ...
            users: {
                 ...
                 * @example NotificationsService.subscriptions.users.create({     
                                channel: '<channel-name>',     
                                userId: '<user-id>' 
                            })
                            .then(function (data) {     
                ...
                */
                 ...
                 * @param options Query resource options object.
                 * @returns A promise that is resolved once the find action has been performed.                               
                 * @example NotificationsService.subscriptions.users.find({     
                                pageNumber : 1,     
                                pageSize : 10,     
                                orderBy : '<field>',     
                                orderDirection : '<asc|desc>',     
                ...
                */
                 ...
                 * @param options Query resource options object.
                 * @returns A promise that is resolved once the get action has been performed.                               
                 * @example NotificationsService.subscriptions.users.get('<subscription-id>')
                             .then(function (data) {     
                                 // perform success action here 
                             },
                                function (response, status, headers, config) {     
                ...
                */
                 ...
                 * @example // subscription is a resource previously fetched using get action.				 
                                NotificationsService.subscriptions.users.remove(subscription)
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
                ...
                */
                 ...
                 * @example // subscription is a resource previously fetched using get action. 
                                 subscription.channel = '<channel-name>'; 
                                 NotificationsService.subscriptions.users.update(subscription)
                                     .then(function (data) {     
                                         // perform success action here 
                                     },
                                        function (response, status, headers, config) {     
                ...
                */
                ...
                batch: {
                     ...
                     * @returns A promise that is resolved once the create user subscription action has been performed.                                    
                     * @example NotificationsService.subscriptions.users.batch.create([{     
                                    channel: '<channel-name>',     
                                    userId: '<user-id>' 
                                }])
                                .then(function (data) {     
                    ...
                    */
                     ...
                     * @returns A promise that is resolved once the remove action has been performed.                                
                     * @example NotificationsService.subscriptions.users.batch.remove(subscriptionIds)
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
                    ...
                    */
                     ...
                     * @example NotificationsService.subscriptions.users.batch.update(subscriptions)
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
    ...
    get registrations(): INotificationsRegistrationsService {
        let baasicApp = this.baasicApp;
        return {
            anonymous: {
                /**                          
                 ...
                 * @example NotificationsService.registrations.anonymous.create({     
                ...
                */
                 ...
                 * @param options Query resource options object.
                 * @returns A promise that is resolved once the find action has been performed.                                
                 * @example NotificationsService.registrations.anonymous.find({     
                             pageNumber : 1,     
                             pageSize : 10,     
                             orderBy : '<field>',     
                             orderDirection : '<asc|desc>',     
                ...
                */
                 ...
                 * @param options Query resource options object. 
                 * @returns A promise that is resolved once the get action has been performed.                                
                 * @example NotificationsService.registrations.anonymous.get('<registration-id>')
                                .then(function (data) {     
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {     
                ...
                */
                 ...
                 * @example // registration is a resource previously fetched using get action.				 
                                NotificationsService.registrations.anonymous.remove(registration) 
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
                ...
                */
                 ...
                 * @example // registration is a resource previously fetched using get action. 
                                    ...
                                    NotificationsService.registrations.anonymous.update(registration)
                                        .then(function (data) {         
                                            // perform success action here 
                                        },
                                        function (response, status, headers, config) {         
                ...
                */
                ...
                batch: {
                     ...
                     * @returns A promise that is resolved once the create anonymous registration action has been performed.                                     
                     * @example NotificationsService.registrations.anonymous.batch.create([{     
                                    provider: '<provider-name>',     
                                    providerData: <provider-data>,     
                    ...
                    */
                     ...
                     * @returns A promise that is resolved once the remove action has been performed.                                    
                     * @example NotificationsService.registrations.anonymous.batch.remove(subscriptionIds) 
                                 .then(function (data) {     
                                     // perform success action here 
                                 },
                                    function (response, status, headers, config) {     
                    ...
                    */
                     ...
                     * @returns A promise that is resolved once the update anonymous registration action has been performed.                                     
                     * @example NotificationsService.registrations.anonymous.batch.update(registrations)
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
            ...
            users: {
                 ...
                 * @example NotificationService.registrations.users.create({     
                                provider: '<provider-name>',     
                                providerData: <provider-data>,     
                                userId: '<user-id>' 
                            }) 
                ...
                */
                 ...
                 * @param options Query resource options object.
                 * @returns A promise that is resolved once the find action has been performed.                              
                 * @example NotificationService.registrations.users.find({     
                             pageNumber : 1,     
                             pageSize : 10,     
                             orderBy : '<field>',     
                             orderDirection : '<asc|desc>',     
                ...
                */
                 ...
                 * @param options Query resource options object.                               
                 * @example NotificationService.registrations.users.get('<registration-id>') 
                             .then(function (data) {     
                                 // perform success action here 
                             },
                                function (response, status, headers, config) {     
                ...
                */
                 ...
                 * @example // registration is a resource previously fetched using get action.				 
                                NotificationService.registrations.users.remove(registration)
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
                ...
                * @example // registration is a resource previously fetched using get action.                             
                               ...
                               NotificationService.registrations.users.update(registration)                             
                                   .then(function (data) {                                  
                                       // perform success action here                            
                                   },
                                   function (response, status, headers, config) {                                  
               ...
               */
                ...
                batch: {
                     ...
                     * @returns A promise that is resolved once the create user registration action has been performed. 
                     * @example NotificationsService.registrations.users.batch.create([{     
                                    provider: '<provider-name>',     
                                    providerData: <provider-data>,     
                                    userId: '<user-id>' 
                                }])
                    ...
                    */
                     ...
                     * @returns A promise that is resolved once the remove action has been performed.                                    
                     * @example NotificationsService.registrations.users.batch.remove(subscriptionIds)
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
                    ...
                    */
                     ...
                     * @returns A promise that is resolved once the update user registration action has been performed.                                
                     * @example NotificationsService.registrations.users.batch.update(registrations)
                                    .then(function (data) {     
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {     
    ...
    get settings(): INotificationsSettingsService {
        let baasicApp = this.baasicApp;
        return {
            /**                      
             ...
             * @returns A promise that is resolved once the get action has been performed. 
             * @example NotificationsService.settings.get('<provider-name>')
                            .then(function (data) {     
                                // perform success action here 
                            },
                            function (response, status, headers, config) {     
            ...
            */
             ...
             * @example // settings is a resource previously fetched using get action. 
                            NotificationsService.settings.update(settings) 
                                .then(function (data) {         
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {         
