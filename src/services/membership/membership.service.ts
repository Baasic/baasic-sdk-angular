...
export class MembershipService {
    ...
    get login(): ILoginService {
        ...
        return {
            ...
            **/
             ...
             * @method 				
             * @example MembershipService.login.loadUserData()
                            .then(function (data) {   
                                // perform success actions here 
                            },
                            function (data) {   
            ...
            */
             ...
             * @example let token = baasicAuthorizationService.getAccessToken(); 
                        MembershipService.login.logout(token.access_token, token.token_type)
                        .then(function (data) {   
    ...
    get loginSocial(): ILoginSocialService {
        ...
        return {
             ...
             * @example MembershipService.loginSocial.get('<provider>', '<returnUrl>')
            ...
            **/
             ...
             * @example let postData = {   
                        ...
                        MembershipService.loginSocial.post('<provider>', postData)
                            .then(function (collection) {  
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
    ...
    get role(): IRoleService {
        ...
        return {
             ...
             * @example MembershipService.role.find({   
                            pageNumber : 1,   
                            pageSize : 10,   
                            orderBy : '<field>',   
            ...
            **/
             ...
             * @returns A promise that is resolved once the get action has been performed.              
             * @method                         
             * @example MembershipService.role.get('<role-id>')
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example MembershipService.role.create({ 
            ...
            **/
             ...
             * @example // role is a resource previously fetched using get action. 
                            role.name = '<new-name>'; 
                            MembershipService.role.update(role)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @method                         
             * @example // Role is a resource previously fetched using get action.				 
                            MembershipService.role.remove(role)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
    ...
    get user(): IUserService {
        ...
        return {
             ...
             * @example MembershipService.user.exists('<username>')
                            .then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
            ...
            **/
             ...
             * @method
             * @param options Query resource options object.                         
             * @example MembershipService.user.find({   
                            pageNumber : 1,   
                            pageSize : 10,   
                            orderBy : '<field>',   
                            orderDirection : '<asc|desc>',   
            ...
            **/
             ...
             * @returns A promise that is resolved once the get action has been performed.                           
             * @example MembershipService.user.get({   
                            username : '<username>',   
            ...
            **/
             ...
             * @example MembershipService.user.create({   
            ...
            **/
             ...
             * @example // user is a resource previously fetched using get action. 
                            ...
                            MembershipService.user.update(user)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example // user is a resource previously fetched using get action.				 
                            MembershipService.user.remove(user)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example //  user is a resource previously fetched using get action.				 
                                MembershipService.user.unlock(user)
                                    .then(function (data) {   
                                        // perform success action here 
                                    },
                                    function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example // user is a resource previously fetched using get action.				 
                            MembershipService.user.lock(user)
                                .then(function (data) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @example // user is a resource previously fetched using get action.				 
                            MembershipService.user.approve(user)
                                .then(function (data) {   
                                    // perform success action here 
                                })
                                function (response, status, headers, config) {   
            ...
            **/
             ...
             * @method                         
             * @example // user is a resource previously fetched using get action.				 
                            MembershipService.user.disapprove(user).then(function (data) {   
                                // perform success action here 
                            },
                            function (response, status, headers, config) {   
                                // perform error handling here 
            ...
            **/
             ...
             * @example MembershipService.user.changePassword('<username>', {   
                            newPassword : '<new-password>',   
            ...
            **/
            ...
            socialLogin: {
                 ...
                 * @returns A promise that is resolved once the get action has been performed.                     
                 * @method                    
                 * @example MembershipService.user.socialLogin.get('<username>')
                                .then(function (collection) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
                ...
                **/
                 ...
                 * @returns A promise that is resolved once the remove action has been performed.                 
                 * @method                 
                 * @example MembershipService.user.socialLogin.remove('<username>', '<provider>')
                                .then(function (collection) {   
                                    // perform success action here 
                                },
                                function (response, status, headers, config) {   
