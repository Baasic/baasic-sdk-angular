...
import { IKeyValue } from 'contracts/keyValue';
...
export class KeyValueService {
     ...
     * @method
     * @example KeyValueService.get('<key-value-id>')
                    .then(function (data) {   
                        // perform success action here 
                    },
                     function (response, status, headers, config) {   
     ...
     * @method
     * @example KeyValueService.create({key: '<key>', value: '<value>', })
                    .then(function (data) {   
                        // perform success action here 
                    },
                     function (response, status, headers, config) {   
    ...
    * @method 
    * @example // keyValue is a resource previously fetched using get action.				 
                   KeyValueService.remove(keyValue) 
                   .then(function (data) {   
                       // perform success action here 
                   },
                    function (response, status, headers, config) {   
